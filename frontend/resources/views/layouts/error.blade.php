...
<html lang="pt-BR">
    ...
    <body>
        ...
        <main class="container d-flex flex-column justify-content-center align-items-center main-content">
            <div class="text-center">
                <h2 class="status_code"> @yield('code', '404') </h2>
                <p class="subtitle"> @yield('message', '') </p>
                <a class="btn btn-primary" href="{{ route('home') }}">Voltar para o início</a>
            </div>
        </main>
