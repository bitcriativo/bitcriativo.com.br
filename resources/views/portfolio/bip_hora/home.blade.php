...
@section('content')
    <!-- Hero Start -->
    <header class="hero" style=" background-image: url('{{ asset('bip-hora/assets/images/bg_hero.png') }}'); background-size: cover; background-position-x: center; background-position-y: bottom;">
        <h2 class="display-1">The best products start with Figma</h2>
        <p class="paragraph">Most calendars are designed for teams. </p>
    ...
    <!-- Features Start -->
    <section class="space-y-8 my-32 xl:my-64 max-w-7xl mx-auto">
        <h2 class="text-center justify-start text-slate-800 text-5xl font-normal font-sans leading-[55px] tracking-tight">Features</h2>
        <div class="text-center justify-start text-gray-700 text-3xl font-normal font-sans leading-10 tracking-tight">Most calendars are designed for teams. </div>
        <img class="lg:hidden" class="mx-auto" src="{{ asset('bip-hora/assets/images/image_feature_1.png') }}"/>

        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:my-34">
            <div class="my-5">
        ...
        <div class="space-y-8 lg:flex lg:space-x-4 lg:justify-evenly xl:my-64">
            <div>
                <div class="text-center lg:text-start justify-start text-slate-800 text-5xl font-normal font-sans leading-[55px] tracking-tight">Fastest way to organize </div>
                <div class="text-center lg:text-start justify-start text-gray-700 text-3xl font-normal font-sans leading-10 tracking-tight">Most calendars are designed for teams. </div>
            ...
            <div>
                <img class="mx-auto" src="{{ asset('bip-hora/assets/images/image_feature_2.png') }}" />
            </div>
        </div>
    </section>
    <!-- Features End -->
    ...
    <!-- Newsletter Start -->
    <section class="my-32 space-y-8 px-4 max-w-7xl mx-auto">
        ...
        <p class="text-center justify-start text-gray-700 text-3xl font-normal font-sans leading-10 tracking-tight">Most calendars are designed for teams. Slate is designed for freelancers</p>
        <div class="lg:flex lg:justify-evenly">
            <img src="{{ asset('bip-hora/assets/images/image_newsletter_1.png') }}" />
            <div class="my-4">
                <div class="justify-start text-slate-800 text-xl font-bold font-sans leading-7 tracking-tight">Subscribe to our Newsletter</div>
                <div class="justify-start text-gray-700 text-lg font-normal font-sans leading-normal tracking-tight">Available exclusivery on Figmaland</div>
                <div class="w-full py-6 inline-flex flex-col justify-start items-start gap-3 overflow-hidden">
                    ...
                    <button href="#" class="w-full px-4 py-2 my-4 bg-blue-500 rounded-[35px] flex-col inline-flex items-center gap-2.5 overflow-hidden justify-start text-white text-lg font-normal font-sans leading-tight tracking-tight">
                        Subscribe
                    </button>
                </div>
            </div>
    ...
    <!-- Partners Start -->
    <section class="space-y-8 my-32 xl:my-64 xl:space-y-12 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 xl:grid-cols-3">
            <div class="mx-auto w-72 px-10 py-6 bg-white outline outline-offset-[-1px] outline-zinc-300 inline-flex flex-col justify-start items-center gap-3.5 overflow-hidden">
                <div class="justify-start text-gray-700 text-base font-normal font-sans leading-snug tracking-tight">Client Name</div>
    ...
    <!-- Testimonials Start -->
    <section class="my-32 lg:my-64 max-w-7xl mx-auto">
        ...
        <div class="paragraph--testimonials">Most calendars are designed for teams. Slate is designed for freelancers who want a <br/>simple way to plan their schedule.</div>
    ...
    <!-- Contact Start -->
    <section class="my-32 max-w-7xl mx-auto">
        ...
        <div class="my-6 text-center justify-start text-gray-700 text-3xl font-normal font-sans leading-10 tracking-tight">Most calendars are designed for teams. </div>
        ...
        <div class="flex flex-col-reverse lg:flex-row">
            ...
            <div class="w-full lg:w-6/12">
                <address class="space-y-4 my-24 lg:flex lg:space-x-4 lg:space-y-0 *:flex *:gap-4 *:lg:flex-col *:lg:items-center">
                    <div>
                        <div>
                ...
                <img class="mx-auto my-8" src="{{ asset('bip-hora/assets/images/image_contact_1.png') }}" />
    ...
    <!-- Footer Start -->
    <footer class="bg-slate-800 w-full">
        <div class="max-w-7xl mx-auto *:my-4 py-24 grid grid-cols-1 xl:grid-cols-4 xl:gap-8">
